...
class UserpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userpost" do
    assert_difference('Userpost.count') do
      post userposts_url, params: { userpost: { content: @userpost.content, title: @userpost.title } }
    end
  ...
  test "should update userpost" do
    patch userpost_url(@userpost), params: { userpost: { content: @userpost.content, title: @userpost.title } }
